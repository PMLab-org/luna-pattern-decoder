...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Luna is an AI perimenopause companion that connects the dots between your symptoms so you understand what your body is telling you." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Luna — AI Perimenopause Companion" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Outfit:wght@500;600;700&family=Lora:ital,wght@0,400;0,500;1,400;1,500&display=swap",
      },
    ],
  }),
